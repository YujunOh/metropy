...
Fetch data from Fast Exit API and save to data_raw
"""
...
def fetch_all_fast_exit_data(batch_size=1000, max_records=5000, save_dir="data_raw"):
    """
...
if __name__ == "__main__":
    ...
    # Save Line 2 data
    line2_path = Path("../data_raw/fast_exit_line2.json")
