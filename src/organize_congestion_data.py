...
Filter and copy Line 2 congestion data from inputs/ to data_raw/
"""
...
def organize_hourly_station_data():
    ...
    try:
        ...
        if line_col:
            ...
            if len(df_line2) > 0:
                # Save to data_raw
                output_path = Path("../data_raw/hourly_line2_station_cnt.csv")
...
def organize_station_master():
    ...
    dst_path = Path("../data_raw/station_master.csv")
...
def organize_interstation_distance():
    ...
    dst_path = Path("../data_raw/interstation_distance_time.csv")
...
if __name__ == "__main__":
    ...
    print("="*70)
    print("\nNext steps:")
    print("  1. Check data_raw/ directory")
