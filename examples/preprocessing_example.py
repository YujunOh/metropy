...
datasets2 = preprocessor2.run_full_pipeline(
    fast_exit_path="data_raw/fast_exit.json",
    congestion_path="data_raw/congestion.csv",
    station_master_path="data_raw/station_master.csv",
    distance_path="data_raw/distance.csv",
    save=True
)
